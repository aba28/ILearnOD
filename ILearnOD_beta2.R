...
setwd("/Users/aliabbasi/Box Sync/IDPH/opioids mortality/decode death cert/verification/")

##### Enter the names of the files we will be using 
death.file<-"deaths.xlsx"           ### Death records, can be csv, txt, xls, xlsx
...
wordfields<-c('IMMED_CAUSE_DEATH',
              'CONSQ1',
              'CONSQ2',
              'OTH_SIGNF_CONDS',
              'INJURY_HOW_OCCUR')
